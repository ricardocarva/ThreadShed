...
#Strip will remove any character in the beginning or end of the word that matches
#Replace will affect all characters that match the criteria
...
for sale in thread_sold:
  #It splits around the &. If there is no & in a sale, it will not split and just append
